        ...
        <div class="input-group-lg" style=" margin-left: 30%;margin-top: 3%">
                ...
                <div class="text-field ${hasErrors(bean: user, field: 'username', 'error')} required">
                    <dt>
                        <label for="username" class="etiquetasProducto">
                            ...
                            <g:message code="user.username.label" default="Nombre Usuario:"/>
                        </label>
                    </dt>
                    <dd>
                ...
                <div class="text-field ${hasErrors(bean: user, field: 'password', 'error')} required">
                    <dt>
                        <label for="password" class="etiquetasProducto">
                            <span class="required-indicator">*</span>
                            <g:message code="user.pass
                                    word.label" default="Contraseña:"/>
                        </label>
                    </dt>
                    <dd>
            ...
            <dl class="dl-horizontal">
                <div class="text-field ${hasErrors(bean: user, field: 'email', 'error')} required">
                    <dt>
                        <label for="rfc" class="etiquetasProducto">
                            <span class="required-indicator">*</span>
                            <g:message code="user.rfc.label" default="R.F.C:"/>
                        </label>
                    </dt>
                    <dd>
                        <f:input bean="user" property="rfc"/>
                    </dd>
                </div>
            </dl>
            <dl class="dl-horizontal">
            ...
            <div align="center">
                <g:submitButton name="show" class="btn btn-lg btn-danger" value="${message(code: 'default.button.create.label', default: 'Guardar')}" />
            </div>
        </div>
    </g:form>
</div>
